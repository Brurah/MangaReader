    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                if (!rootFrame.Navigate(typeof(Starter), args.Arguments))
                {
        ...
        private async void CreateDatabase()
        {
            ...
            //{
            //    db.CreateTable<Fontes>();
            //    db.CreateTable<Mangas>();
            //    db.CreateTable<TipoGeneros>();
            //    db.CreateTable<Generos>();
            //    db.CreateTable<Capitulos>();
            //}
